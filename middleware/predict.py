...
dataset.columns = ['Energy', 'Cloud Coverage', 'Visibility', 'Temperature', 'Dew Point', 'Relative Humidity', 'Wind Speed']
dataset.index.name = 'Date'
# mark all NA values with 0
dataset['Energy'].fillna(0, inplace=True)
# summarize first 5 rows
print(dataset.head(5))
# save to file
dataset.to_csv('../data/energy.csv')
